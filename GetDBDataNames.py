...
arcpy.env.workspace = r"Database Connections\gis_gisp.sde"#agsdev01_osd4.sde"#gis_osd4.sde"

output = r"C:\WorkSpace\ReportDataSources\wvmoap_138_132_X_gis_gisp_OUTPUT\DatabaseFeatureClasses.txt"
